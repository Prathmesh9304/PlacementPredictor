...
import { FaGraduationCap, FaChartLine, FaUserGraduate, FaBook, FaProjectDiagram, FaComments, FaLaptopCode } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-6 sm:py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-6 sm:mb-10">
          <h1 className="text-2xl sm:text-4xl font-bold text-blue-800 mb-2 sm:mb-3">Placement Prediction Form</h1>
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-2">
            Fill in your details below to get a prediction of your placement chances based on our machine learning model.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="transition-all duration-300 hover:shadow-md p-3 sm:p-4 rounded-lg">
              ...
              >
                ...
                <option value="Computer Science in AIML">Computer Science in AIML</option>
                <option value="Computer Science in Data Science">Computer Science in Data Science</option>
                <option value="Computer Science and Design">Computer Science and Design</option>
                <option value="Electrical and Electronics Engineering">Electrical and Electronics Engineering</option>
                <option value="Chemical Engineering">Chemical Engineering</option>
                <option value="Production Engineering">Production Engineering</option>
                <option value="IMsc Maths and Computing">IMsc Maths and Computing</option>
              </select>
            </div>
            ...
            <div className="transition-all duration-300 hover:shadow-md p-3 sm:p-4 rounded-lg">
              <label className="flex items-center text-gray-700 font-medium mb-1 sm:mb-2 text-sm sm:text-base">
                <FaComments className="mr-2 text-blue-600" /> Communication Level (1-5)
              </label>
              <div className="flex items-center">
                <input
                  ...
                  required
                />
                <span className="ml-3 font-medium text-blue-600">{formData.communicationLevel}</span>
              </div>
          ...
          <div className="mt-6 sm:mt-8 bg-blue-50 p-4 sm:p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="flex items-center p-2 sm:p-3 bg-white rounded-lg shadow-sm transition-all hover:shadow-md">
                ...
                />
                <label htmlFor="internships" className="ml-2 sm:ml-3 text-gray-700 text-sm sm:text-base">Internship Experience</label>
              </div>
              ...
              <div className="flex items-center p-2 sm:p-3 bg-white rounded-lg shadow-sm transition-all hover:shadow-md">
                <input
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="training" className="ml-2 sm:ml-3 text-gray-700 text-sm sm:text-base">Training</label>
              </div>
              ...
              <div className="flex items-center p-3 bg-white rounded-lg shadow-sm transition-all hover:shadow-md">
                <input
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="backlog" className="ml-2 sm:ml-3 text-gray-700 text-sm sm:text-base">Backlog in 5th Semester</label>
              </div>
              ...
              <div className="flex items-center p-3 bg-white rounded-lg shadow-sm transition-all hover:shadow-md">
                <input
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="innovativeProject" className="ml-2 sm:ml-3 text-gray-700 text-sm sm:text-base">Innovative Project</label>
              </div>
              ...
              <div className="flex items-center p-3 bg-white rounded-lg shadow-sm transition-all hover:shadow-md">
                <input
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 rounded focus:ring-blue-500"
                />
                <label htmlFor="technicalCourse" className="ml-2 sm:ml-3 text-gray-700 text-sm sm:text-base">Technical Course</label>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 text-center">
            <button
              ...
              className={`px-6 py-2 sm:px-8 sm:py-3 bg-blue-600 text-white rounded-lg font-medium text-base sm:text-lg shadow-md 
                ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-blue-700 transform hover:scale-105'} 
